  ...
  return (
    <KeyboardAwareScreen style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.form}>
        ...
        <Text style={styles.helper}>Register your profile and get started.</Text>

        <SocialAuthPanel role="creator" intent="register" errorMessage="Could not create account with social account. Please try again." />

        <AuthFooterText
          prefix="Already have an account?"
          action="Log In!"
          onPress={() => navigation.navigate('CreatorSignIn')}
          style={styles.footer}
        />
      </View>
    </KeyboardAwareScreen>
